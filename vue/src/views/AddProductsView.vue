<template>
  <div class="container-lg">
    <div v-if="!types_loading && !categories_loading" class="row justify-content-center">
      <div class="form-title">
        <h2>Product form</h2>
      </div>
      <div class="col-lg-6 col-md-8 col-sm-10">
        <form @submit.prevent="addProduct" class="border p-4 rounded shadow" style="min-width: 530px">
