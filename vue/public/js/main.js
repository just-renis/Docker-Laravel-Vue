...
var userModule = {
  ...
  getters: {
    GET_MESSAGE: function GET_MESSAGE(state) {
      return state.message;
    },
    GET_VALUE: function GET_VALUE(state) {
      return state.value;
    }
  },
  mutations: {
    ...
    SET_VALUE: function SET_VALUE(state, value) {
      state.value = value;
    }
  },
  actions: {
    fetchData: function fetchData(_ref) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('http://localhost:9000/api/sample-data').then(function (response) {
...
/* harmony import */ var _components_MainPage_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/MainPage.vue */ "./src/components/MainPage.vue");
/* harmony import */ var _components_MainPage_vue__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_MainPage_vue__WEBPACK_IMPORTED_MODULE_3__);




var app = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)((_App_vue__WEBPACK_IMPORTED_MODULE_2___default()));
app.component('main-page', (_components_MainPage_vue__WEBPACK_IMPORTED_MODULE_3___default()));
